...
const NewTaskModal = () => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-[100dvh] bg-black/30 flex items-center justify-center">
      <div className="w-[400px] min-h-[400px] bg-white rounded-xl px-4 py-3 relative">
        ...
        <form onSubmit={handleSubmit} className="mt-3 space-y-3">
          ...
          <CustomButton text="Add" className="w-full py-4 mt-3"></CustomButton>
        </form>
